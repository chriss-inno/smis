...
@section('modals')
    <script>
        ...
        $(".addClass").click(function(){
            ...
            modal+= '<span id="myModalLabel" class="h2 modal-title text-center text-info" style="text-align: center">Create Education Level</span>';
            modal+= '</div>';
...
@section('menus')
    ...
    <div class="page-heading">
        <h1><i class='fa fa-table'></i> EDUCATION LEVELS </h1>
    </div>
    <div class="row">
